...
enum class Tile {
	...
	DOUBLE_ROUND_TILE_MINI_TL, DOUBLE_ROUND_TILE_MINI_TR, DOUBLE_ROUND_TILE_MINI_BL, DOUBLE_ROUND_TILE_MINI_BR=5,
	DOUBLE_END_LEFT=75, DOUBLE_END_RIGHT=74,
	
	//SINGLE
	STRAIGHT_LINE_HORIZONTAL_UP=43, STRAIGHT_LINE_HORIZONTAL_DOWN=42, STRAIGHT_LINE_VERTICAL_RIGHT=41, STRAIGHT_LINE_VERTICAL_LEFT=40,
